...
{
    Vec3S32 c = {(S32)mix_1f32((F32)a.x, (F32)b.x, t), (S32)mix_1f32((F32)a.y, (F32)b.y, t),
...
{
    Vec4F32 c = {mix_1f32(a.x, b.x, t), mix_1f32(a.y, b.y, t), mix_1f32(a.z, b.z, t),
                 mix_1f32(a.w, b.w, t)};
    return c;
}
...
{
    Vec4S32 c = {(S32)mix_1f32((F32)a.x, (F32)b.x, t), (S32)mix_1f32((F32)a.y, (F32)b.y, t),
                 (S32)mix_1f32((F32)a.z, (F32)b.z, t), (S32)mix_1f32((F32)a.w, (F32)b.w, t)};
    return c;
}
...
inverse_4x4f32(Mat4x4F32 m)
{
    ...
    Vec4F32 inv0 =
        add_4f32(sub_4f32(mul_4f32(vec1, fac0), mul_4f32(vec2, fac1)), mul_4f32(vec3, fac2));
    Vec4F32 inv1 =
        add_4f32(sub_4f32(mul_4f32(vec0, fac0), mul_4f32(vec2, fac3)), mul_4f32(vec3, fac4));
    Vec4F32 inv2 =
        add_4f32(sub_4f32(mul_4f32(vec0, fac1), mul_4f32(vec1, fac3)), mul_4f32(vec3, fac5));
    Vec4F32 inv3 =
        add_4f32(sub_4f32(mul_4f32(vec0, fac2), mul_4f32(vec1, fac4)), mul_4f32(vec2, fac5));
...
linear_from_srgb(Vec3F32 srgb)
{
  ...
  for
      ...
      {
          result.v[idx] =
              (srgb.v[idx] < 0.0404482362771082f ? srgb.v[idx] / 12.92f
...
{
    Vec4F32 result = v4f32(((hex & 0xff000000) >> 24) / 255.f, ((hex & 0x00ff0000) >> 16) / 255.f,
