...
bbox_pipeline(vulkan::Context* vk_ctx, String8 shader_path)
{
    ...
    String8 vert_path = CreatePathFromStrings(scratch.arena, Str8BufferFromCString(scratch.arena, {(char*)shader_path.str, "bin", "bbox_pipeline_vert.spv"}));
    String8 frag_path = CreatePathFromStrings(scratch.arena, Str8BufferFromCString(scratch.arena, {(char*)shader_path.str, "bin", "bbox_pipeline_frag.spv"}));
    String8 tese_path = CreatePathFromStrings(scratch.arena, Str8BufferFromCString(scratch.arena, {(char*)shader_path.str, "bin", "bbox_pipeline_tese.spv"}));
    String8 tesc_path = CreatePathFromStrings(scratch.arena, Str8BufferFromCString(scratch.arena, {(char*)shader_path.str, "bin", "bbox_pipeline_tesc.spv"}));
    ...
    VkPipelineShaderStageCreateInfo shader_stages[] = {vert_shader_stage_info.info, tesc_shader_stage_info.info, tese_shader_stage_info.info, frag_shader_stage_info.info};
    ...
    vk_ctx->bbox_patch_descriptor_set_layout =
        descriptor_set_layout_create(vk_ctx->device, {{0, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 1, VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT | VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT, NULL}});

    VkDescriptorSetLayout descriptor_set_layouts[] = {vk_ctx->camera_descriptor_set_layout, vk_ctx->bbox_patch_descriptor_set_layout, vk_ctx->bindless_descriptor_set_layout};
