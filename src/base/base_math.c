...
static Vec2F32 Sub2F32(Vec2F32 a, Vec2F32 b) {
  Vec2F32 c = {a.x - b.x, a.y - b.y};
  return c;
}
...
static Mat4x4F32 make_perspective_4x4f32(F32 fov, F32 aspect_ratio, F32 near_z,
                                         F32 far_z) {
  Mat4x4F32 result = mat_4x4f32(1.f);
...
static Mat4x4F32 make_orthographic_4x4f32(F32 left, F32 right, F32 bottom,
